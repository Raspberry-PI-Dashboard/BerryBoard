  ...
  return (
    <div className="group relative min-w-0">
      <button
        ...
        className="absolute right-2 top-2 z-10 rounded-md border border-slate-700 theme-panel px-2 py-1 text-sm text-slate-400 opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100 hover:text-slate-100"
        onClick={() => {
