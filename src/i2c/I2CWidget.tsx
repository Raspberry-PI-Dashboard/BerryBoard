          ...
          <div className="flex flex-wrap items-end gap-3">
            {scanResponse && (
              <output className="font-mono text-sm text-slate-300">
                Bus {scanResponse.bus}:{" "}
                {scanResponse.addresses.join(", ") || "No devices"}
              </output>
            )}
          </div>
        </Subsection>
        ...
        <Subsection subtitle="Register operations">
          <div className="grid gap-3 sm:grid-cols-3">
            <Input
              ...
              max={127}
              onChange={(event) =>
                updateConfiguration({ address: event.target.value })
              }
              type="number"
            ...
            <Input
              ...
              max={255}
              onChange={(event) =>
                updateConfiguration({ register: event.target.value })
              }
              type="number"
            ...
            <Input
              ...
              max={255}
              onChange={(event) =>
                updateConfiguration({ value: event.target.value })
              }
              type="number"
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Button
              onClick={() => readRegister(addressNumber, registerNumber)}
              type="button"
            >
              Read register
            </Button>
            <Button
              onClick={() =>
                writeRegister(
                  addressNumber,
                  registerNumber,
                  numberValue(configuration.value),
                )
              }
              type="button"
            >
        ...
        <Subsection subtitle="Block operations">
          <div className="grid gap-3 sm:grid-cols-2">
            <Input
              ...
              max={32}
              onChange={(event) =>
                updateConfiguration({ length: event.target.value })
              }
              type="number"
            ...
            <Input
              ...
              onChange={(event) =>
                updateConfiguration({ data: event.target.value })
              }
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Button
              onClick={() =>
                readBlock(
                  addressNumber,
                  registerNumber,
                  numberValue(configuration.length, 1),
                )
              }
              type="button"
            >
            ...
            <Button
              onClick={() =>
                writeBlock(addressNumber, registerNumber, parseData())
              }
              type="button"
            >
              Write block
          ...
          {(readBlockResponse || writeBlockResponse) && (
            <output className="mt-3 block wrap-break-word font-mono text-sm text-slate-300">
              Data: [
              {(readBlockResponse ?? writeBlockResponse)?.data.join(", ")}]
            </output>
          )}
        </Subsection>
      </fieldset>
